...
var dataAPI = require('./ecommerce_data');
var api;

var cases = dataAPI.getAllCases();
// var cases = dataAPI.getSections(["Authorization Only","Prior Authorization Capture","Authorization-Capture","Void","Refund or Credit","Error Handling"]);

var results = {};

describe("Ecommerce Script", function(){
